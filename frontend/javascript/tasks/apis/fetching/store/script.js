...
const url = 'https://mdn.github.io/learning-area/javascript/apis/fetching-data/can-store';
request.open('GET', url + '/products.json');
...
function initialize(products) {
    ...
    function fetchBlob(product) {
      ...
      let imageUrl = url + '/images/' + product.image;
