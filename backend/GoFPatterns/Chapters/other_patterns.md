...
## Ковариантность (out) - позволяет использовать более производные тип вместого базового в возвращаемых значениях
...
## Контрвариантность (in) - позволяет использовать более базовый тип вместо производного во входных параметрах
